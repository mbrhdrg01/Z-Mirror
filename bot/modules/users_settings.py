...
async def update_user_settings(query):
    ...
    if not ospath.exists(tpath):
        tpath = "https://graph.org/file/3296618866592e0c2c65c.jpg"
...
Examples:
1. <code>{escape('<b>Join: [MM]</b>')}</code> 
This will give output as:
<b>Join: [MM]</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: [MM]</code>')}</code> 
This will give output as:
<code>Join: [MM]</code> <code>69MB.bin</code>.
